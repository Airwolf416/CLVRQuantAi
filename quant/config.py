...
DEFAULT_COINS = os.getenv(
    "QUANT_COINS",
    "BTC,ETH,SOL,WIF,DOGE,AVAX,LINK,ARB,kPEPE,XRP,BNB,ADA,DOT,POL,UNI,AAVE,"
    "NEAR,SUI,APT,OP,TIA,SEI,JUP,ONDO,RENDER,INJ,FET,TAO,PENDLE,HBAR,TRUMP,HYPE",
).split(",")
HL_TO_APP = {"kPEPE": "PEPE"}
APP_TO_HL = {"PEPE": "kPEPE"}
HL_SCALE = {"kPEPE": 0.001}
