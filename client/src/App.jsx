      ...
      <div style={{padding:"10px 12px",position:"relative",zIndex:1}}>
        ...
        {tab==="help"&&<>
          ...
          {[
            ...
            {cat:"Pulse — Unusual Activity",color:C.gold,items:[
              {q:"What is the Pulse tab?",a:"Pulse scans tracked assets for UNUSUAL MARKET CONDITIONS — abnormal price velocity, volume, funding, open interest, and volatility expansion — and scores each 0–100. It is information and education only. It is NOT a prediction, a buy/sell signal, or financial advice. Conditions that precede volatility also produce many false positives."},
              {q:"How do I read a Pulse score?",a:"Each card shows a 0–100 score and a band: QUIET (under 50), ELEVATED (50–64), HIGH (65–79), EXTREME (80+). The bullet lines explain which sub-signals fired — e.g. accelerating price velocity, a volume spike vs the 1-minute average, extreme funding, or expanding volatility. Higher just means 'more abnormal right now,' not 'will go up.'"},
              {q:"Should I trade off Pulse alerts?",a:"No — treat Pulse as a heads-up to go LOOK, not a trade. Always confirm with your own analysis and the Quant Engine before acting. Be especially careful with low-cap tokens, where 'unusual activity' is often a pump being set up. Always do your own research."},
              {q:"Why is everything QUIET?",a:"On calm days nothing crosses into ELEVATED/HIGH — that's correct behavior. Pulse only surfaces the least-quiet names. You'll see higher bands during genuinely volatile sessions."},
            ]},
