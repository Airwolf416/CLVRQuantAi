...
const STEPS = [
  {
    ...
    body: "CLVRQuant gives you real-time prices across every major asset class, AI-generated trade signals, a macro calendar, and CLVR AI analysis — all in one mobile-first dashboard.",
    cta: null,
    tab: null,
  },
  {
