...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Watchlist system — mark any asset with the ✦ symbol for quick filtering",
  ...
  },
  {
    ...
    items: [
      ...
      "Ask AI button — get Claude's take on any macro event",
  ...
  },
  {
    ...
    icon: "04",
    items: [
      "AI-generated daily market commentary powered by Claude",
  ...
  },
  {
    ...
    items: [
      ...
      "Watchlist filter — show only signals for your tracked assets",
  ...
  },
  {
    ...
    items: [
      ...
      "AI Analyst mode — sends all signal data to Claude for structured trade ideas with cross-asset reasoning",
  ...
  },
  {
    ...
    icon: "09",
    items: [
      "Claude-powered market analysis with full context (all live prices, news, signals)",
